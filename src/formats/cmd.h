...
// misma ruta de codigo para fade, wipe y disolucion"). Ver render/shaders.h para la formula
...
struct Cmd {
    ...
    union {
        ...
        // shader de render/shaders.h; el umbral (0..1) lo conduce cmd_timer/seconds, igual
...
// Tope de opciones por @choice. Antes de M15 no habia ninguno: option_count es un u8, asi
// que el formato admitia 255, y la UI —que hasta M15 no dibujaba las opciones en absoluto—
// no tenia por que saberlo. Con la UI real hace falta un numero fijo para reservar los
// layouts sin asignar en el frame, y el sitio donde comprobarlo es el compilador, donde el
// error sale con archivo y linea, no la UI, donde solo se podria truncar en silencio.
//
// 8 es lo que cabe en pantalla con holgura a 1920x1080 y muy por encima de lo que un menu
// de novela visual legible ofrece de una vez.
constexpr u32 k_max_choice_options = 8;
