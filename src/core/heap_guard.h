...
// Cuenta las asignaciones de heap hechas via operator new/delete durante SZ_DEBUG y
// SZ_EDITOR (Debug y Dev). En Ship no existe overhead: las funciones se compilan vacias y
...
// lua/lua_bindings.cpp, nunca un ambito mas amplio.
//
...
// `hot_reload_update` que lanza `sz_bake`), y con un interruptor el resume interno
